  ...
  return (
    <div className="content">
      ...
      <div className="panel" style={{ marginTop: "var(--space-6)" }}>
        ...
        <div className="panelBody">
          <p className="subtitle">
            Diese Vorhersagen werden durch Machine-Learning-Modelle unterstuetzt, die auf historischen
            Daten trainiert wurden. Der Frachtkostenvorhersager verwendet historische Versanddaten zur
            Schaetzung der Containerkosten, waehrend der Kaffeepreisvorhersager Qualitaetsmerkmale und
            Markttrends analysiert. Alle Vorhersagen enthalten Konfidenz-Scores zur Beurteilung der
            Zuverlaessigkeit.
          </p>
        </div>
      </div>
