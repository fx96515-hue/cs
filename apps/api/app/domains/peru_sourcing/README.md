# Domain: peru_sourcing

## Purpose
Owns business logic and API contracts for the **peru_sourcing** capability.
...
## Dependency Rules
- Prefer imports from `app.domains.peru_sourcing.*` inside this domain.
