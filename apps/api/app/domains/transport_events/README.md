# Domain: transport_events

## Purpose
Owns business logic and API contracts for the **transport_events** capability.
...
## Dependency Rules
- Prefer imports from `app.domains.transport_events.*` inside this domain.
