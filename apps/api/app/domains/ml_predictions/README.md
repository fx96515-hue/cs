# Domain: ml_predictions

## Purpose
Owns business logic and API contracts for the **ml_predictions** capability.
...
## Dependency Rules
- Prefer imports from `app.domains.ml_predictions.*` inside this domain.
